...
echo "Fetching RovoDev Hub installer (${TARGET_REF})..."
...
LAUNCHER_PATH="${EXTRACTED_ROOT}/rovodev-launcher.command"
if [ ! -f "$LAUNCHER_PATH" ]; then
  echo "Could not find launcher in downloaded archive (${LAUNCHER_PATH})." >&2
